...
const InputTags = (props) => {
    ...
    return (
        <div className="relative">
            ...
            <textarea
                id="title"
                className={`resize-y max-h-32 min-h-12 block bg-amber-100 w-3/12 hover:bg-amber-200 py-2 rounded m-3 self-center inline-block ${isInputValueDoi ? 'border-2 border-green-500' : ''}`}
                placeholder=" DOI..."
                type="text"
                required
                value={inputValue}
            ...
            <label class="inline-flex items-center cursor-pointer inline-block">
